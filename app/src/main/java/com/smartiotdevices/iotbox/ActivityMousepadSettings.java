...
public class ActivityMousepadSettings extends AppCompatPreferenceActivity
{
    ...
    private static Preference.OnPreferenceChangeListener BIND_PREFERENCE_SUMMARY_TO_VALUE_LISTENER = (preference, value) ->
    {
    ...
    private static void bindPreferenceSummaryToValue(Preference preference)
    {
        ...
        BIND_PREFERENCE_SUMMARY_TO_VALUE_LISTENER.onPreferenceChange(preference, PreferenceManager.getDefaultSharedPreferences(preference.getContext()).getString(preference.getKey(), ""));
    }
}
