...
public class FrgHotspotManagement extends Fragment implements SwipeRefreshLayout.OnRefreshListener
{

    public FrgHotspotManagement()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        SwipeRefreshLayout swipeLayout = rootView.findViewById(R.id.swipe_webview_hotspot);
        swipeLayout.setOnRefreshListener(this);
        String webUA = "Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.9.0.4) Gecko/20100101 Firefox/4.0";

        WebView webView = rootView.findViewById(R.id.webview_hotspot);
        ...
        webView.loadUrl("http://"+SessionController.getSessionController().getSessionUserInfo().getHost());
