...
public class AlertDialog implements BlockingOnUIRunnableListener
{
    ...
    {
        android.app.AlertDialog alert =  new android.app.AlertDialog.Builder(_activityParent).setMessage(_message).setNegativeButton("No", new DialogInterface.OnClickListener()
        {
